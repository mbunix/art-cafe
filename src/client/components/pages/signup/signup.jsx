...
const [passwordStrength, setPasswordStrength] = useState({
  ...
  const submitHandler = (e) => { 
    ...
    if(passwordStrength !== true){
      ...
      dispatch( SignUp(firstname, lastname, email, area, password) ,reset())
    }
  }
  useEffect(() => {
    if (userInfo) {
  ...
  return (
    <FormContainer>
      ...
      {loading && <Loader />}
      <Form className='signup-form' onSubmit={(e) => { submitHandler; handleSubmit(e) }}>
      ...
      <div className='signup-form-group'>
        <Form.Group controlId='email'>
          ...
          <Form.Group controlId='location'>
            ...
            <Form.Control as='select' {...register('location')} type = 'area' value = { area }  onChange={e => setArea(e.target.value)}>
              {options.map(option => (
